...
- Declare 3 int variables for grades.  Ask the user for three integer valuess.  Read the input values and store them.  
...
- Print out the average in a statement.  (See sample output below.)
- Declare a double variable and calculate the variance.  (See formula above)
- Declare a double variable to compute the standard deviation. (See formula above)
- Print out the variance and standard deviation in a sentence

  	For example, your output might look like:

      Enter three integers, separated by "Enter".
      78
      80
      77
